...
// /// 1 form handling : useState, onChange , onSubmit(print the detials on console)
// // 2. interaction with redux : useDispatch , useSelector
// // 3. action in submit
// // 3. side effects : useEffect ==> edit profile
// // 4. navigation : useNavigate ==> after creating profile go to dashboard
// const emptyForm = {
//   company: "",
//   website: "",
//   location: "",
...
// const CreateProfile = () => {
//   const createProfile = useMatch("/profile/create-profile"); // true / false
...
//     // after creating the profile successfully
//     // navigate to the dashboard
//     console.log({ ...formData, skills: skills.split(",") });
//     dispatch(
//       createOrUpdateProfileAction({ ...formData, skills: skills.split(",") })
//     );
//   };
//   const socialDetails = (
//     <>
...
//     [createProfile]
//   );
//   // to load the content ==> before rendering.
//   useEffect(() => {
//     if (!createProfile) dispatch(getCurrentProfileAction());
//   }, [dispatch, createProfile]);

//   useEffect(() => {
//     let isMounted = true;
//     if (!profile || loading) return;
//     // we have to align the data to the form
//     let profileData = null;
//     if (profile) {
//       profileData = { ...emptyForm };
...
//         <h1 class="large text-primary">{title}</h1>
//         <p class="lead">
//           <i class="fas fa-user"></i> {subtitle}
//         </p>
...
// // render exp
// // logout
// // testing of react component (intro.)
// src/components/profile/CreateProfile.jsx
import React, { useEffect, useMemo, useState } from "react";
import { Link, useMatch, useNavigate } from "react-router-dom";
import { useDispatch, useSelector } from "react-redux";
import {
